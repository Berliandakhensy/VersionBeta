...
local InfoTab = Window:MakeTab({ Title = "Informasi", Icon = "rbxassetid://15309138473" })



InfoTab:AddSection({ "Informações do Script" })
InfoTab:AddParagraph({ "Pemilik / Pengembang:", "Luscaa and veno." })
InfoTab:AddParagraph({ "Kontributor:", "Blue, sukuna, Magekko, Darkness, Star, Toddy" })
InfoTab:AddParagraph({ "Anda sedang menggunakan:", "Chaos Hub Brookhaven " })
InfoTab:AddParagraph({"Your executor:", executor})

InfoTab:AddSection({ "Gabung Ulang" })
InfoTab:AddButton({
    Name = "Gabung Ulang",
    Callback = function()
...
local TrollTab = Window:MakeTab({ Title = "Skrip Troll", Icon = "rbxassetid://13364900349" })


TrollTab:AddSection({ "Lubang Hitam" })
TrollTab:AddButton({
    Name = "Lubang Hitam",
...
TrollTab:AddSection({ "Menjadi Tak Terlihat" })

TrollTab:AddButton({
    Name = "Ficar Menjadi Tak Terlihat",
...
TrollTab:AddSection({ "Warna Avatar RGB" })
...
TrollTab:AddToggle({
    Name = "RGB Character",
    Description = "Buat karakter Anda menjadi RGB",
    Default = false,
...
-- Tab 4: Anti Duduk
TrollTab:AddSection({ "Anti Duduk" })
TrollTab:AddToggle({
    Name = "Anti Duduk",
...
Troll:AddButton({
    Name = "Bunuh dengan Banned Rumah",
...
local NOME_FERRAMENTA = "Click Lempar Bola"
local ferramentaEquipada = false
...
Tab:AddParagraph({"Informasi", "Loop de tocar Áudio (Todos players do Server ouvem)"})
...
Tab:AddParagraph({"Informasi", "Todos do server ouvem o áudio"})
